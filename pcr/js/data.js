...
var axis = [
	...
	{"work_id" : "D0", "text" : "112 yls 连点 ub 1.7w；107 狼（穿衣105） 连点 ub 1.6w；106 狗（狼穿衣105正中突后） 普攻后 ub 4w；105 猫拳 普攻后 ub 3w；059 黑骑 连点 ub；058 yls 连点 ub 4.2w；048 狼（穿衣045），猫拳，yls 劈砍后 ub 1.6w，2.8w，4.2w；036 狗，yls 黑骑撞破甲后 ub 4w，4.4w；032 猫拳 普攻后 ub 3w；031 纯 断奶 ub；029 狼（穿衣026） 连点 ub 1.6w；020 yls 黑骑破甲，yls普攻后 ub 4w；019 狗 普攻后 ub 4w；013 yls 连点 ub 4.2w；004 狼 狼吼黑骑撞后 ub 1.6w；002 猫拳，狗 普攻 ub 2.8w，4w；"},
	...
	{"work_id" : "F2", "text" : "1:07 狼 boss1晕miss圈到后 ub 1.3w 狼吼、深月红圈；1:03 狼、玲奈、栞 连点 ub 1.3w、6.2w、1.6w 狼ub、狼吼、深月红圈；0:58 黄骑 充玲奈后 ub；0:54 深月 劈砍后卡后摇 ub；0:50 暴击弓 连点 ub 2.8w；0:49 栞 1根箭伤害后 ub 1.2w 狼ub、深月红圈；0:45 狼 连点 ub 9k；0:30 狼、栞 连点（狼ub时不能出现强力斩击气泡） ub 2.6w、2.7w；0:27 暴弓 连点（卡掉飞镖） ub 6.2w 狼ub、深月红圈；0:23 黄骑 充玲奈后 ub；0:16 狼（0:20boss不晕狼） 深月红圈后 ub；0:12 狼、玲奈→栞 狼三闪后（玲奈在暴击弓箭矢到达螃蟹时） ub 1.4w、6.2w、3.2w 狼ub、狼吼、深月红圈；0:01 深月、栞 深月红圈后 ub 2.7w；"},
	{}
];
...
//二周目二王
{"id" : "B0", "boss_id" : "B2", "hp" : 122e4, "cfg" : "纯4狗5狼4傻4栞5", "group_type" : group_type.hq, "count" : 23, "src" : "私服轴 BV1Ls411j7DC", "creater" : "私服轴", "checker" : "参考轴", "cp_id" : ""},
{"id" : "B1", "boss_id" : "B2", "hp" : 120e4, "cfg" : "纯4狗5狼5咲5栞5", "group_type" : group_type.hq, "count" : 30, "src" : "BV1ck4y1m7JD", "creater" : "Tsukasa", "checker" : "英普洛001"},
//一周目三王
...
//二周目四王
{"id" : "D0", "boss_id" : "B4", "hp" : 123e4, "cfg" : "纯4狗5狼5猫拳5傻4", "group_type" : group_type.hq, "count" : 14, "src" : "BV1Qi4y137Rb", "creater" : "随翼随翼", "checker" : "草莓"},
...
//二周目五王狂暴
{"id" : "F2", "boss_id" : "B6", "hp" : 73e4, "cfg" : "狼5黄5深4暴5栞5", "group_type" : group_type.sy, "count" : 30, "src" : "BV1ck4y1m7JD", "creater" : "草莓、李维特安", "checker" : "大光裤衩"},
